...
public class Patient {
	...
	public String toString() {
		...
		builder.append("Patient [id=").append(id).append(", dateUpdated=").append(dateUpdated).append(", updatedBy=")
				...
				.append(", isActive=").append(isActive).append(", doctorId=").append(doctorId).append("]");
